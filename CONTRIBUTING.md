# Contributing to Devil AI

Thanks for your interest in contributing to Devil AI! This document covers the basics for
getting started.
...
apps/
  ...
  telegram-bot/  Telegram Bot for remote control
packages/
  ui/            Shared shadcn/ui component library (@devil-ai/ui)
  configconv/    Universal agent config converter
  configconv-cli/ CLI wrapper for the config converter
  aiden/         Aiden autonomous agent runtime (vendored)
  aiden-bridge/  Bridge between Devil AI and Aiden
...
Devil AI uses [Biome](https://biomejs.dev/) for linting and formatting. Key conventions:
...
Open an issue on [GitHub](https://github.com/ItsWendell/devil-ai/issues) with:

- Steps to reproduce
- Expected behavior
- Actual behavior
- Your OS, Devil AI version, and OpenCode version

## License

By contributing to Devil AI, you agree that your contributions will be licensed under the
[MIT License](LICENSE).

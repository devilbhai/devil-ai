/**
 * Lockfile for the Devil AI-managed engine server process.
 *
 * Written when Devil AI spawns a server, removed on clean shutdown. On next
 ...
 *
 * Path: ~/.local/share/devil-ai/server.lock
 */

...
export const ignoredProjectsAtom = atomWithStorage<string[]>("devil_ai_ignored_projects", [])
 ...
 * - `starting-server`: waiting for the engine server to start/connect
...
export interface DiscoveryState {
	...
	/** Projects discovered from the engine API (Project type from SDK) */

 ...
 * from detected providers (Claude Code, Cursor, Devil AI). Migration
...
const isMac = isElectron && window.devilAi.platform === "darwin"
...
export function CompleteStep({
	...
	useEffect(() => {
		...
		window.devilAi.onboarding
			.detectProviders()
			.then((detections) => {
				// Only show providers that were found and aren't Devil AI itself
				// (no point migrating Devil AI -> Devil AI)
		...
		<div className="flex h-full flex-col items-center justify-center px-6">
			<div className="w-full max-w-md space-y-8 text-center">
				...
				<p className="text-sm text-muted-foreground">
					{opencodeVersion
						? `Devil AI is connected to engine ${formatVersion(opencodeVersion)}`
						: "Devil AI is ready to go"}

 ...
 * Devil AI Zen is featured prominently as the built-in provider with free models.
	...
	if (!serverConnected) {
		return (
			...
			<div className="flex flex-col items-center space-y-2">
				...
				<h2 className="text-xl font-semibold">Waiting for engine...</h2>
				<p className="max-w-md text-sm text-muted-foreground">
					Devil AI is connecting to the background engine process. This should only take a moment.
				</p>
			</div>
		...
		<div className="flex h-full flex-col items-center justify-center space-y-8 px-6 text-center">
			<div className="max-w-md space-y-2">
				...
				<p className="text-muted-foreground">
					Free models are included with Devil AI. Connect additional providers for more model
					choices.
				</p>
			</div>

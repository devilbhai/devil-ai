...
const IDS = {
	// Projects
	projectDevilAI: "proj-a1b2c3d4e5f6",
...
const DIRS = {
	"devil-ai": "/Users/demo/Projects/devil-ai",
...
const mockDiscoveredProjects: DiscoveryState["projects"] = [
	{
		id: IDS.projectDevilAI,
		worktree: DIRS["devil-ai"],
		vcs: "git",
		name: "devilAi",
...
function assistantMsg(
	...
	return {
		...
		mode: "Adaptive",
		agent: "code",
		path: { cwd: DIRS["devil-ai"], root: DIRS["devil-ai"] },
...
/** Project slug for the default session (devil-ai project) */
export const MOCK_DEFAULT_PROJECT_SLUG = `devil-ai-${IDS.projectDevilAI.slice(0, 12)}`

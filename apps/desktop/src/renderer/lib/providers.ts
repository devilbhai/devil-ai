...
// ============================================================
// Devil AI Built-in Provider (formerly OpenCode Zen)
// ============================================================

/** The provider ID for Devil AI built-in provider (always auto-loads, free tier available) */
export const ZEN_PROVIDER_ID = "opencode"

/** The provider ID for the native DevilRoute provider injected at engine startup. */
export const DEVIL_AI_PROVIDER_ID = "devil-ai"

/** Display name shown in the UI for the native DevilRoute provider. */
export const DEVIL_AI_DISPLAY_NAME = "Devil-Ai"

/** URL to sign up for a Devil AI API key */
export const ZEN_SIGNUP_URL = "https://opencode.ai/zen/"

/** URL to Devil AI provider documentation */
...
export const PROVIDER_KEY_URLS: Record<string, { label: string; url: string }> = {
	...
	"privatemode-ai": { label: "Get API key", url: "http://127.0.0.1:8080" },
	agentrouter: { label: "Get API key", url: "https://agentrouter.org" },
}

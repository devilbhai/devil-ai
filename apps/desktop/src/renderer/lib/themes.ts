// ============================================================
// Theme definitions for Devil AI
//
...
// Key traits:
//   - Neutral (cool) grays
//   - Devil AI Blue accent (#05bdf5 base, oklch 228.71 hue)
...
export const cortexTheme: ThemeDefinition = {
	id: "cortex",
	name: "Cortex",
	description: "Cool neutrals with Devil AI Blue accent, clean and minimal",
	cssVars: {
		light: {
...
//     Devil AI Blue fallbacks, so they track the OS accent color

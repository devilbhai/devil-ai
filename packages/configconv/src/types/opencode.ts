/**
 * DevilCode type definitions.
 *
 * Re-exports canonical types from @devilcode/sdk where available,
...
export type OpenCodeMcp =
	| import("@devilcode/sdk/v2/client").McpLocalConfig
	| import("@devilcode/sdk/v2/client").McpRemoteConfig
	| { enabled: boolean }
...
export interface OpenCodeAgentFrontmatter {
	...
	color?: string
	steps?: number
	permission?: import("@devilcode/sdk/v2/client").PermissionConfig
	hidden?: boolean
}
